...
import '../styles/CadastrarGasto.css';
...
function CadastrarGasto() {
  ...
  return (
    <div className="cadastrar-gasto-container">
      {/* Título */}
      <header className="cadastrar-gasto-header">
        <h1>Cadastrar Gasto</h1>
      </header>

      {/* Corpo da página */}
      <main className="cadastrar-gasto-body">
        ...
        <section className="navigation-buttons">
          <button onClick={() => navigate('/exibir-gastos')}>Ver Gastos</button>
          <button onClick={() => navigate('/')}>Ir para Home</button>
        </section>
      </main>

      {/* Rodapé */}
      <footer className="cadastrar-gasto-footer">
